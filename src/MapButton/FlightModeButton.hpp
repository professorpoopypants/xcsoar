...
#ifndef XCSOAR_FLIGHT_MODE_BUTTON_HPP
#define XCSOAR_FLIGHT_MODE_BUTTON_HPP
...
class FlightModeButton : public MapButton {
protected:
  bool task_abort;
...
public:
   ...
   * @param _second
   */
  void Update(bool _task_abort, DisplayMode _display_mode);
};
