...
#include "org_xcsoarrd_InternalGPS.h"
#include "org_xcsoarrd_NonGPSSensors.h"
...
Java_org_xcsoarrd_InternalGPS_setConnected(JNIEnv *env, jobject obj,
                                         jint connected)
{
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_InternalGPS_setLocation(JNIEnv *env, jobject obj,
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NonGPSSensors_setAcceleration(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NonGPSSensors_setRotation(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NonGPSSensors_setMagneticField(
...
/**
 * Helper function for
 * Java_org_xcsoarrd_NonGPSSensors_setBarometricPressure: Given a
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NonGPSSensors_setBarometricPressure(
