...
#include "Compiler.h"
#include "org_xcsoarrd_NativeView.h"
...
Java_org_xcsoarrd_NativeView_initializeNative(JNIEnv *env, jobject obj,
                                            jobject _context,
...
Java_org_xcsoarrd_NativeView_runNative(JNIEnv *env, jobject obj)
{
  InitThreadDebug();
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NativeView_deinitializeNative(JNIEnv *env, jobject obj)
{
  InitThreadDebug();
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NativeView_resizedNative(JNIEnv *env, jobject obj,
                                         jint width, jint height)
{
  if (event_queue == NULL)
    return;
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NativeView_pauseNative(JNIEnv *env, jobject obj)
{
  if (event_queue == NULL)
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NativeView_resumeNative(JNIEnv *env, jobject obj)
{
  if (event_queue == NULL)
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_org_xcsoarrd_NativeView_setHapticFeedback(JNIEnv *env, jobject obj,
                                             jboolean on)
{
