...
#include "org_xcsoarrd_NativeInputListener.h"
...
Java_org_xcsoarrd_NativeInputListener_dataReceived(JNIEnv *env, jobject obj,
...
{
  cls.Find(env, "org/xcsoarrd/NativeInputListener");
