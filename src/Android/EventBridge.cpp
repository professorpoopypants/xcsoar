...
#include "org_xcsoarrd_EventBridge.h"
...
void
Java_org_xcsoarrd_EventBridge_onKeyDown(JNIEnv *env, jclass cls, jint key_code)
{
  if (event_queue == NULL)
...
gcc_visibility_default
void
Java_org_xcsoarrd_EventBridge_onKeyUp(JNIEnv *env, jclass cls, jint key_code)
{
  if (event_queue == NULL)
    /* XCSoar not yet initialised */
    return;
...
gcc_visibility_default
void
Java_org_xcsoarrd_EventBridge_onMouseDown(JNIEnv *env, jclass cls,
                                        jint x, jint y)
{
  if (event_queue == NULL)
    /* XCSoar not yet initialised */
...
gcc_visibility_default
void
Java_org_xcsoarrd_EventBridge_onMouseUp(JNIEnv *env, jclass cls,
                                      jint x, jint y)
{
  if (event_queue == NULL)
    /* XCSoar not yet initialised */
...
gcc_visibility_default
void
Java_org_xcsoarrd_EventBridge_onMouseMove(JNIEnv *env, jclass cls,
                                        jint x, jint y)
{
  if (event_queue == NULL)
    /* XCSoar not yet initialised */
...
gcc_visibility_default
void
Java_org_xcsoarrd_EventBridge_onPointerDown(JNIEnv *env, jclass cls)
{
  if (event_queue == NULL)
    /* XCSoar not yet initialised */
    return;
...
gcc_visibility_default
void
Java_org_xcsoarrd_EventBridge_onPointerUp(JNIEnv *env, jclass cls)
{
  if (event_queue == NULL)
    /* XCSoar not yet initialised */
    return;
